...
import Table from '../../components/dashboard/Location/table';
import Form from '../../components/dashboard/Location/Form';
...
const Location = () => {
  ...
  return (
    <>
      <div className='h-svh'>
        <div className='h-24 bg-gradient-to-b from-cyan-700 from-10% to-cyan-700/40 flex items-end py-3 px-20'>
        ...
        <div className='flex justify-center items-center py-5'>
          <Table setData={setData} setOpen={setOpen} searchQuery={searchQuery} />
        </div>
